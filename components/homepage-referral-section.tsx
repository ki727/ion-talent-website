    ...
    <section className="scroll-mt-24 py-16 md:py-20 px-6 bg-ion-surface border-t border-gray-100">
      <div className="container mx-auto max-w-5xl">
        <FadeIn>
          ...
          >
            {/* Subtle atmospheric texture rather than a flat navy rectangle —
                low opacity, heavily overlaid, so it reads as depth, not a
                photo. Kept well behind a strong navy wash for readability. */}
            <img
              src="/photography/abstract-teal-purple.webp"
              alt=""
              aria-hidden="true"
              loading="lazy"
              className="absolute inset-0 h-full w-full object-cover opacity-[0.18] mix-blend-soft-light"
            />
            <div className="absolute inset-0 bg-ion-navy/75" aria-hidden="true" />
